...
def main():
    ...
    parser.add_argument('--s_dir', type=str, default='/home/lw462/CBIM/mxnet/example/DINP',
                        help='set the server working dir')
    parser.add_argument('--w_dir', type=str, default='/home/lw462/CBIM/mxnet/example/DINP',
                        help='set the worker working dir')
    ...
    if args.host_file is None or args.host_file == 'None':
      ...
      if args.cluster == 'ssh':
          from dmlc_tracker import ssh_DINPS
          ssh_DINPS.submit(args)
